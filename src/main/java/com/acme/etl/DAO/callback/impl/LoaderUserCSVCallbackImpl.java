...
import com.acme.etl.DAO.impl.LoaderUserCSVImpl;
 ...
 */
public class LoaderUserCSVCallbackImpl implements LoaderUserFromFileCallback {

    // Variables declaration
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(LoaderUserCSVCallbackImpl.class);
    
    private final LoaderUserCSVImpl loadUsers;
    // End of variables declaration
    
    public LoaderUserCSVCallbackImpl(String path) {
        ...
        loadUsers = new LoaderUserCSVImpl(ui, path, 2);
        loadUsers.execute();
    }
...
//            log.info("id: '" + user.getId() + "'; name: '" + user.getName() + "';");
    ...
    public void startLoading() {
        log.info("Start load user from *.csv file.");
    }

    @Override
    public void stopLoading() {
        log.info("Stop load user from *.csv file.");
    }
